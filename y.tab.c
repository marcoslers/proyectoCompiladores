...
{
  "$end", "error", "$undefined", "REGRESA", "DEF", "DESPLIEGA", "SI",
  "OTRO", "MIENTRAS", "ASIGNA", "IGUAL", "DIFERENTE", "MAYOR", "MENOR",
  "MAYORIG", "MENORIG", "AND", "OR", "ID", "ENTERO", "CADENA", "INT",
...
{
      13,     5,    15,     1,     2,     6,     7,     8,    11,    14,
      12,    10
};

static const yytype_uint8 yycheck[] =
{
      12,    22,    14,     5,     6,    22,     0,    21,    23,     7,
      23,     6
};
